...
> **Source.** This is a copy of the protocol reference from the upstream project,
> [`anthropics/claude-desktop-buddy` · `REFERENCE.md`](https://github.com/anthropics/claude-desktop-buddy/blob/main/REFERENCE.md).
> It is reproduced here for convenience so the Android port can be implemented against it offline.
> The upstream repository is the source of truth — check it for the latest version.
